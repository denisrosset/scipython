...
(Details [here](setup/spellcheck.md)).

We mention additional extensions [in the version control settings page](setup/versioncontrol.md), the main ones:

- [Local History](https://marketplace.visualstudio.com/items?itemName=xyz.local-history)
- [Git History](https://marketplace.visualstudio.com/items?itemName=donjayamanne.githistory)

We discuss [extras extensions](extras.md) at a different place.
